  ...
  var DEMO = {
    ...
    elevage_animaux: [
      { id: 'ea-1', module: 'poulailler', nom: 'Doucette', race: 'Rousse',
        date_arrivee: jourCourt(-300), statut: 'reforme', notes: 'la plus douce, se laisse prendre sans bouger — âgée, ne pond presque plus',
      ...
      { id: 'ea-2', module: 'poulailler', nom: 'Noisette', race: 'Rousse',
        date_arrivee: jourCourt(-300), statut: 'present', notes: 'robe plus claire, couleur noisette',
      ...
      { id: 'ea-3', module: 'poulailler', nom: 'Long Bec', race: 'Rousse',
        date_arrivee: jourCourt(-300), statut: 'reforme', notes: 'bec nettement plus long que les autres — âgée, ne pond presque plus',
      ...
      { id: 'ea-4', module: 'poulailler', nom: 'Petite Crête', race: 'Rousse',
        date_arrivee: jourCourt(-40), statut: 'present', notes: 'crête basse — la dernière arrivée',
    ...
    elevage_historique: [
      ...
      { id: 'eh-11', module: 'poulailler', date_evenement: jourCourt(-6), type_evenement: 'note', quantite: null,
        description: 'Deux Chantecler prévues au printemps, en remplacement de Doucette et Long Bec (réformées). Le règlement plafonne à 4 : leur départ doit précéder l’arrivée.' },
